...
namespace Ovr
{
    ...
    public struct Matrix4f
    {
        ...
        internal Matrix4f(float m00, float m01, float m02, float m03, float m10, float m11, float m12, float m13, float m20, float m21, float m22, float m23, float m30, float m31, float m32, float m33)
        {
            this.m = new float[,]{
                { m00, m01, m02, m03 },
                { m10, m11, m12, m13 },
    ...
    public struct TrackingState
    {
        ...
        /// </summary>
        [FieldOffset(192)]
        public UInt32 LastCameraFrameCounter;
    ...
    public struct RenderAPIConfigHeader
    {
        ...
        [FieldOffset(4)]
        public Sizei BackBufferSize; // Previously named RTSize.
        [FieldOffset(12)]
    ...
    public class Hmd : IDisposable
    {
        ...
        public const int OVR_DEFAULT_EYE_RELIEF_DIAL = 3;
        public static float[] OVR_DEFAULT_CAMERA_POSITION = { 0f, 0f, 0f, 1f, 0f, 0f, 0f };
        ...
        /// </summary>
        public void SetEnabledCaps(HmdCaps capsBits)
        {
            ovrHmd_SetEnabledCaps(HmdPtr, (uint)capsBits);
        }
        ...
        /// </summary>
        public bool ConfigureTracking(TrackingCaps supportedTrackingCaps, uint requiredTrackingCaps)
        {
            return ovrHmd_ConfigureTracking(HmdPtr, (uint)supportedTrackingCaps, requiredTrackingCaps) != 0;
        }
        ...
        public string GetString(string propertyName, string defaultVal = null)
        {
            ...
            if (p == IntPtr.Zero)
                return defaultVal;
            var res = Marshal.PtrToStringAnsi(p);
